    ...
    <div className="min-h-screen bg-white text-slate-900 antialiased selection:bg-blue-100 selection:text-blue-900">
      ...
      <main>
        ...
        <section className="relative overflow-hidden">
          ...
          <div className="relative max-w-[1400px] mx-auto px-6 lg:px-10 pt-20 sm:pt-28 lg:pt-36 pb-20 sm:pb-28">
            <div className="flex flex-col items-center text-center">
              {/* Badges */}
              <div className="inline-flex flex-nowrap items-center gap-2 sm:gap-3 mb-8">
